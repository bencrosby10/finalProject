    ...
    <div class="event-view-content">
        ...
        <div class="events-card">
            ...
            <div class="events-card-text">
                ...
                <h4 class="events-card-subtitle">Saturday April 8<sup>th</sup><br>9:00 am - 12:00pm</h4>
        ...
        <div class="events-card">
            ...
            <div class="events-card-text">
                ...
                <h4 class="events-card-subtitle">Saturday July 15<sup>th</sup><br>9:00 am - 12:00pm</h4>
        ...
        <div class="events-card">
            ...
            <div class="events-card-text">
                ...
                <h4 class="events-card-subtitle">Saturday October 14<sup>th</sup><br>8:00 AM - 12:00 PM</h4>
                <p class="events-card-tags">As we close up the yacht club for the winter, there are a few projects we will be trying to complete on the buildings, boats, and grounds. Whether you are handy with a skill or just happy to come lend a hand, please join us for the morning to get things ship-shape. Also, prior to the project day, there is a project to paint the trim on the club, spare pairs of hands needed,
                    if you have a few hours to spare any sunny day. Please contact <a href="mailto:Jeff.Rabinowitz@worms.com">Jeff.Rabinowitz@worms.com</a> if you have any questions.
                </p>
            </div>
